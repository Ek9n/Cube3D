...
/*   Updated: 2024/05/15 15:27:23 by jborner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_player(t_data *data, int sign, int num)
{
	...
	{
		data->player->angle += (0.000003 * (data->rot[num]
					+ (data->player->speed[0] / 1.4) + 10) * (data->rot[num]
					+ (data->player->speed[0] / 1.4) + 10)
				* data->player->rev_speed * data->player->rev_speed) * sign;
